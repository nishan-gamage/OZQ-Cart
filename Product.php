    ...
    <nav class="desktop-navigation-menu">
      ...
      <div class="container">
        ...
        <ul class="desktop-menu-category-list">
          ...
          <li class="menu-category">
            <a href="shop.php" class="menu-title">Jewelry</a>
  ...
  <div class="overlay" data-overlay></div>
    <section id="prodetails" class="section-p1">
        <div class="singal-pro-image">
            <img src="img/watch/f8.png" width="50%" id="MainImg" alt="">
            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="img/watch/f9.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/watch/f10.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/watch/f8.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
        ...
        <div class="singal-pro-details">
            ...
            <span>Cotton Material<br>
                All sizes are available
            PLEASE NOTE - The Image may be slightly different from the actual product in terms of color due to LIGHTING CONDITIONS or the display used to view. We hope you can seem to understand, it's beyond our ability to get the EXACT product color on the Image.</span>
        </div>
    </section>
